...
### For All Users & Customers (Guests & Buyers)
...
### For Registered Buyers/Customers

Buyers get access to a specialized set of features to enhance their shopping experience.

*   **Simple Sign-Up**: Create a buyer account in minutes to start purchasing.
*   **Secure Product Pickup**: When you purchase a product, a unique 14-digit identification number is generated and shared with both you and the seller. Simply show this number to the seller to verify your purchase and receive your product securely.
*   **Ghost Coin Rewards**: For every 100 products you buy, you'll be issued a special **Ghost Coin** as a reward. The value and use of these coins will be defined in a future update!
*   **Purchase History**: Keep track of all your past orders and unique product identification numbers.
*   **Customizable Appearance**: Personalize your experience by setting custom background wallpapers on different pages.
