...
import { MoreHorizontal, PlusCircle, Trash2, Edit, Loader2, Users, Wallet } from "lucide-react";
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 mb-6">
            <Card>
                ...
                <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">Available to use for payments.</p>
                </CardContent>
            </Card>
        </div>
